...
int main(int argc, char* argv[]){
	...
	if(argc != 5){
		cout << "\nUsage: test_read serialized_reference compressed_file percentage_read n_tests\n";
	...
	cout << "Start (reference \"" << serialized_reference << "\", compressed \"" << compressed_file << "\", percentage " << percentage << ", n_tests " << n_tests << ")\n";
...
//	cout << "Decompression finished in "<<timer.getMilisec()<<" ms\n";
	...
	unsigned long long len_read = size * percentage;
	cout << "len_read: " << len_read <<"\n";
